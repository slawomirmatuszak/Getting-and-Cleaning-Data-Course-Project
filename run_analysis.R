...
path <- getwd()
# creating separate data folder is not required, but I personally prefer to have data in a data directory
if (!file.exists("data")) { 
 dir.create("data") 
}
...
# csv file just in case, as it is more common format for data. 